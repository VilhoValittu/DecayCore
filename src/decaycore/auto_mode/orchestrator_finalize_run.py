...
def _run_phase2_pareto_finalize(
    *,
    ...
    # Inject top phase1 candidates so strong global-search results survive into Pareto
    # even when phase2 local refine is empty or produces nothing better.
    ...
    if phase1_top_for_pool:
        ...
        for p1_item in phase1_top_for_pool:
            ...
            if p1_sig not in existing_preset_sigs:
