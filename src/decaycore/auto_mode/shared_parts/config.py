...
AUTO_MODE_CACHE_SCHEMA_VERSION = 14
AUTO_MODE_COMPAT_VERSION = "am25"
...
AUTO_MODE_PHASE2_PLATEAU_ROUNDS = 5
AUTO_MODE_TARGET_TOP_N = 3
AUTO_MODE_TARGET_TRIALS_PER_CURVE = 4        # builtin candidates per curve; no Optuna, no local refine
AUTO_MODE_TARGET_USE_OPTUNA = False           # target search is curve ranking, not continuous optimization
AUTO_MODE_TARGET_LOCAL_REFINE_ENABLED = False # real optimization happens in subsequent refine phase1
...
AUTO_MODE_OPTUNA_STARTUP_PHASE1 = 6
...
AUTO_MODE_OPTUNA_CONSTRAINTS_MAX_MODE_RIPPLE_DB = 3.20
...
AUTO_MODE_MODE_RIPPLE_OK_DB = 0.100
...
AUTO_MODE_HPF_ALLOWED_SLOPES_DB_OCT = (6, 12, 18, 24, 30, 36, 42, 48)
