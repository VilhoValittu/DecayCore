...
AUTO_MODE_CACHE_SCHEMA_VERSION = 31
AUTO_MODE_COMPAT_VERSION = "am48"
...
AUTO_MODE_TARGET_TRIALS_PER_CURVE = (
    4  # builtin candidates per curve; no Optuna, no local refine
)
AUTO_MODE_TARGET_USE_OPTUNA = (
    False  # target search is curve ranking, not continuous optimization
)
AUTO_MODE_TARGET_LOCAL_REFINE_ENABLED = (
    False  # real optimization happens in subsequent refine phase1
)
...
AUTO_MODE_SYNTH_TARGET_BASS_COMP_FRAC = 0.35  # basson määrä adaptiivisessa käyrässä
...
AUTO_MODE_SYNTH_TARGET_HF_COMP_FRAC = 0.0
...
AUTO_MODE_MAG_C_MIN_MIN_HZ = 10.0
AUTO_MODE_MAG_C_MIN_MAX_HZ = 150.0
AUTO_MODE_MAG_C_MIN_SEARCH_MAX_UP_HZ = 4.0
