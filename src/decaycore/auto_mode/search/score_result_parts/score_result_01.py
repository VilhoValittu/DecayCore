...
def _auto_score_result(
    ...
    *,
    ...
    scoring_range = af["scoring_range"]
    ...
    residual_peak_threshold_db = rp["residual_peak_threshold_db"]
    ...
    stereo_above_hi_hz = sp["stereo_above_hi_hz"]
    ...
    base_rank_components = cr["base_rank_components"]
    focus_ripple = cr["focus_ripple"]
    focus_ripple_l = cr["focus_ripple_l"]
    focus_ripple_r = cr["focus_ripple_r"]
    mode_hz = cr["mode_hz"]
...
def _load_sibling_symbols() -> None:
    import importlib
    package = __package__
    for module_name in ['score_result_01']:
