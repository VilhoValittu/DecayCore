...
from .shared_parts import (
    ...
    AUTO_MODE_MAG_C_MIN_SEARCH_MAX_UP_HZ as SHARED_AUTO_MODE_MAG_C_MIN_SEARCH_MAX_UP_HZ,
...
AUTO_MODE_MAG_C_MIN_WINNER_POLISH_MAX_UP_HZ = SHARED_AUTO_MODE_MAG_C_MIN_SEARCH_MAX_UP_HZ
...
AUTO_MODE_MAG_C_MIN_REF_MIN_HZ = 200.0
AUTO_MODE_MAG_C_MIN_REF_MAX_HZ = 500.0
AUTO_MODE_MAG_C_MIN_SEARCH_MAX_HZ = 150.0
...
AUTO_MODE_HPF_MIN_HZ = 10.0
AUTO_MODE_HPF_MAX_HZ = 150.0
AUTO_MODE_HPF_REF_MIN_HZ = 200.0
AUTO_MODE_HPF_REF_MAX_HZ = 500.0
AUTO_MODE_HPF_SEARCH_MAX_HZ = 150.0
