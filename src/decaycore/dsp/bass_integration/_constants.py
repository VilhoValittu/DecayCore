...
AVR_CROSSOVER_CANDIDATES: tuple[float, ...] = (
    40.0,
    60.0,
    70.0,
    80.0,
...
DIRECT_DAC_CROSSOVER_STEP_HZ = 0.25
DIRECT_DAC_ALLPASS_FREQ_MULTIPLIERS: tuple[float, ...] = (
    0.55,
    0.70,
    0.85,
    1.00,
...
DIRECT_DAC_ALLPASS_Q_CANDIDATES: tuple[float, ...] = (
    0.45,
    0.60,
    0.80,
    1.00,
...
DIRECT_DAC_ALLPASS_REFINE_FREQ_FACTORS: tuple[float, ...] = (
    0.88,
    0.94,
    0.98,
    1.00,
...
DIRECT_DAC_ALLPASS_REFINE_Q_FACTORS: tuple[float, ...] = (
    0.78,
    0.90,
    0.97,
    1.00,
...
DIRECT_DAC_ALLPASS_MIN_IMPROVEMENT_SCORE = 0.04
DIRECT_DAC_ALLPASS_MIN_CANCEL_IMPROVEMENT = 0.010
DIRECT_DAC_ALLPASS_MIN_RIPPLE_IMPROVEMENT_DB = 0.04
DIRECT_DAC_ALLPASS_MIN_GD_IMPROVEMENT_MS = 0.02
MIN_DIRECT_DAC_OVERLAP_RATIO: float = 1.0
DIRECT_DAC_OVERLAP_RATIOS: tuple[float, ...] = (1.0, 1.1, 1.25, 1.4, 1.6, 1.8, 2.0, 2.5, 3.0)
...
DIRECT_DAC_ALIGNMENT_MIN_IMPROVEMENT_SCORE = 0.02
GD_CONTINUITY_GUARD_LO_RATIO = 0.90
