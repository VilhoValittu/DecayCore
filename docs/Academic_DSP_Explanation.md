...
## Academic DSP Rationale and Mathematical Foundations (v1.0.1)
...
The current engine (v1.0.1) uses confidence-aware and safety-bounded processing in both magnitude and phase paths, with optional fixed-grid comparison analysis for reproducible scoring.
