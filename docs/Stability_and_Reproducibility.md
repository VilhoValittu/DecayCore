# Stability and Reproducibility (v1.0.6)
...
Current releases, including `v1.0.6` (2026-05-16), keep this deterministic model while retaining smarter cache reuse around automatic-mode target and preset search.
...
1. Use the same app version (`v1.0.6` or a pinned newer release).
