# Stability and Reproducibility (v1.0.1)
...
Current releases, including `v1.0.1` (2026-05-14), keep this deterministic model while retaining smarter cache reuse around automatic-mode target and preset search.
...
1. Use the same app version (`v1.0.1` or a pinned newer release).
